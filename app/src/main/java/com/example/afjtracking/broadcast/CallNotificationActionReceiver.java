...
public class CallNotificationActionReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null && intent.getExtras() != null) {
            ...
            context.stopService(new Intent(context, NavigationDrawerActivity.class));
    ...
    private void performClickAction(Context context, String action) {
        ...
        if (action.equalsIgnoreCase("RECEIVE_CALL")) {
            ...
            if (/*checkAppPermissions()*/ 1 == 1) {
                ...
                Intent intentCallReceive = new Intent(mContext, NavigationDrawerActivity.class);
                ...
                Intent intent = new Intent(this.mContext, NavigationDrawerActivity.class);
            ...
            cancelNotification(context, _notificationId);
            mContext.stopService(new Intent(context, NavigationDrawerActivity.class));
