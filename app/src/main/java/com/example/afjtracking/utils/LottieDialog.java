...
public class LottieDialog {
    ...
    private final AppCompatButton lottieDialogOKButton;
    private final AppCompatButton lottieDialogCancelButton;
    ...
    public LottieDialog(Context context) {
        ...
        this.lottieDialogOKButton = view.findViewById(R.id.btnOk);
        this.lottieDialogCancelButton=view.findViewById(R.id.btnCancel);
    ...
    public LottieDialog setBothButtonHide(int visibility) {
        this.lottieDialogButtonsLayout.setVisibility(visibility);
        return this;
    }


    public LottieDialog setOKButtonHide(int visibility) {
        this.lottieDialogOKButton.setVisibility(visibility);
        return this;
    }

    public LottieDialog setCancelButtonHide(int visibility) {
        this.lottieDialogCancelButton.setVisibility(visibility);
        return this;
    }

    public AppCompatButton getLottieOKButton()
    {
        return  lottieDialogOKButton;
    }
    public AppCompatButton getLottieCancelButton()
    {
        return  lottieDialogCancelButton;
    }
