...
import com.hnh.webrtc_calling_lib.listners.AppSdpObserver
import com.hnh.webrtc_calling_lib.listners.PeerConnectionObserver
import com.hnh.webrtc_calling_lib.listners.RTCViewListener
import com.hnh.webrtc_calling_lib.listners.SignalingClientListener
import com.hnh.webrtc_calling_lib.utils.Constants
import com.hnh.webrtc_calling_lib.utils.RTCAudioManager
import org.webrtc.*
...
class WebRtcView(
        ...
        rtcClient = RTCClient(
            ...
            object : PeerConnectionObserver() {
                override fun onIceCandidate(p0: IceCandidate?) {
                    ...
                    signallingClient.sendIceCandidate(p0)
    ...
    private fun createSignallingClientListener() = object : SignalingClientListener {
        override fun onConnectionEstablished() {
            ...
            signallingClient.sendMessage("SDP Create success")
    ...
    private fun requestCameraAndAudioPermission(dialogShown: Boolean = false) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(context, CAMERA_PERMISSION) &&
            ActivityCompat.shouldShowRequestPermissionRationale(context, AUDIO_PERMISSION) &&
            !dialogShown
        ) {
